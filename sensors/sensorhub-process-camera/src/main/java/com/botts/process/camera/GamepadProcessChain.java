...
public class GamepadProcessChain extends ExecutableProcessImpl {
    ...
    public static final OSHProcessInfo INFO = new OSHProcessInfo("gamepadchain2", "Gamepad Process Chain", null, GamepadProcessChain.class);
...
//                                    aValue = (double) componentValues[j];
//                                }
                            }
                        }
                    }
