...
Sensor adapter for Wii Remote.


Wii remote will connect via ble
- to connect wii remote hold down the button 1 and button 2 to begin connecting ble device 
  - if the device is not being found, in the battery area press the red sync button
  - 
- 
