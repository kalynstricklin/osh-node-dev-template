        ...
        dataStruct = sweFactory.createRecord()
                ...
                .addField("Tilt_Accelerometer", sweFactory.createRecord()
                        .addField("xyz", sweFactory.createRecord()
                                .definition(SWEHelper.getPropertyUri("acceData"))
                                .addField("X", sweFactory.createQuantity()
                                        .definition(SWEHelper.getPropertyUri("accelX"))
                                        .label("X-accel")
                                        .uom("deg")
                                )
                                .addField("Y", sweFactory.createQuantity()
                                        .definition(SWEHelper.getPropertyUri("accelY"))
                                        .label("Y-accel")
                                        .uom("deg")
                                )
                                .addField("Z", sweFactory.createQuantity()
                                        .definition(SWEHelper.getPropertyUri("accelZ"))
                                        .label("Z-accel")
                                        .uom("deg")
                                )
                        )
                ...
                .addField("Remote", sweFactory.createRecord()
                        .addField("Buttons",sweFactory.createRecord()
                                ...
                                .addField("2", sweFactory.createBoolean()
                                        .definition(SWEHelper.getPropertyUri("button2"))
                                        .value(false)
                                        .label("2"))
                                ...
                                .addField("PLUS", sweFactory.createBoolean()
                                        .definition(SWEHelper.getPropertyUri("buttonPlus"))
                                        .value(false)
                                        .label("Plus"))
                                .addField("MINUS", sweFactory.createBoolean()
                                        .definition(SWEHelper.getPropertyUri("buttonMinus"))
                                        .value(false)
                                        .label("Minus"))
                                .addField("NONE", sweFactory.createBoolean()
                                        .definition(SWEHelper.getPropertyUri("buttonNone"))
                                        .value(false)
                                        .label("none")
                                )
                        )
